...
为了确保不同 AI (Gemini/Claude/Cursor) 能统一调用本技能 库，所有 Agent 环境必须安装以下标准 MCP 服务，以“拉平”底层能力差异：
...
| **filesystem** | 文件系统读写 | (Native) 基础能力，所 有技能的前置依赖 |

## 🧠 核心能力 (Core Capabilities)

- [深度思考 (Think)](./think-skill.md) - 苏格拉底式引导 与多维分析，用于复杂问题拆解。
...
- [掘金文章助手](./juejin-writer.md) - 撰写幽默且硬核的 技术文章，自动配图与排版。
- [飞书文档助手](./feishu-writer.md) - 撰写结构清晰的团 队内部技术文档。
...
- [gitlab-manager](./gitlab-manager.md) - GitLab 仓库与 流水线管理专家。
...
- [Cloudflare R2 上传器](./cf-r2-uploader.md) - R2 图床 上传与链接获取工具。

## 📚 知识管理 (Knowledge Management)

- [自动复盘 (Auto Retro)](./auto-retro.md) - 自动记录 Bug 与经验，定期归档与 GC。
- [Milvus 工具集](./milvus-toolkit.md) - 本地向量库的检 索、入库与维护工具。
...
- [Remotion Master](./remotion_master.md) - 视频创作与渲 染专家。