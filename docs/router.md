...
| **GitHub/推送** | `rules/github_ops_sop.md` | 执行认证与推送流程 || **复盘/经验** | `retrospectives/index.md` | 加载历史教训 |
| **小红书/运营** | `skills/xhs-commander.md` | 执行多账号自动化运营与互动 || **技能/插件** | `skills/index.md` 或 `ls skills/` | 获取专项能力 |
