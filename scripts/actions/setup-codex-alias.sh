...
START_MARK="# >>> CORTEXOS_BRAIN_CODEX_ALIAS_START >>>"
END_MARK="# <<< CORTEXOS_BRAIN_CODEX_ALIAS_END <<<"
...
$START_MARK
# Auto-generated by CortexOS: codex/gemini/claude brain bootstrap shortcuts
